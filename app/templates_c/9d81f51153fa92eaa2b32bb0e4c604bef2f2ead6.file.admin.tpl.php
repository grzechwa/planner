<?php /* Smarty version Smarty-3.1-DEV, created on 2015-09-16 00:43:59
...
?>
		...
		<tr>
			...
			<input type="hidden" name="id" value="<?php echo $_smarty_tpl->tpl_vars['item']->value['id_user'];?>
"/>	
	...
	<tr><td><a href="<?php echo $_smarty_tpl->tpl_vars['conf']->value->action_root;?>
goAddUser" >Dodaj nowego uzytkownika</a></td></tr>
	</table>
...
?>
		<tr>
			<td>
				<?php echo $_smarty_tpl->tpl_vars['i']->value['nazwa'];?>
